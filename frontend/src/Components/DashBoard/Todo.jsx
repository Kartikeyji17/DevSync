    ...
    return (
      <div className="p-4 rounded-xl bg-[var(--card)] dark:bg-gray-800 border border-[var(--border)] dark:border-gray-700 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-[var(--muted-foreground)] dark:text-gray-400">
            {done}/{total} completed
          </span>
        </div>
        <div className="mt-3 w-full h-3 bg-[var(--accent)]/30 dark:bg-gray-600 rounded-full overflow-hidden">
          <div
            className="h-full bg-[var(--primary)] dark:bg-blue-500"
            style={{ width: `${percent}%` }}
          />
        </div>
        <p className="mt-2 text-sm text-[var(--muted-foreground)] dark:text-gray-400">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-3">
          <button
            ...
            className="mt-1 p-1 rounded-full hover:bg-[var(--accent)] dark:hover:bg-gray-700/50"
          ...
          <div>
            <h4 className="font-semibold text-[var(--card-foreground)] dark:text-gray-100">
              {task.title}
            </h4>
            {task.description && (
            ...
            {task.deadline && (
              <p className="text-xs mt-1 text-[var(--muted-foreground)] dark:text-gray-400">
